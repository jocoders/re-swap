...
contract ReSwapPairTest is Test {
    ...
    //     assertEq(reSwapPair().toke130n1(), address(0), 'token1 have to be 0');
    //   }
    ...
    //     vm.expectRevert();
    //     reSwapPair().testValidateSwap(0, 0);

    //     vm.expectRevert();
    //     reSwapPair().testValidateSwap(AMOUNT_0 + 1, 0);

    //     vm.expectRevert();
    //     reSwapPair().testValidateSwap(0, AMOUNT_1 + 1);
    //   }

    //   function testST() public {
    //     prepareTransfer();
    ...
    //     vm.expectRevert();
    //     reSwapPair().transferPair(1_999_999, 599_456, address(token0), RESERVE_0, RESERVE_1);

    //     vm.expectRevert();
    //     reSwapPair().transferPair(1_999_999, 599_456, address(token1), RESERVE_0, RESERVE_1);
    //   }
    ...
    //     reSwapPair().transferPair(AMOUNT_0, AMOUNT_1, Alice, RESERVE_0, RESERVE_1);

    //     reSwapPair().transferPair(AMOUNT_1, AMOUNT_0, Bob, RESERVE_0, RESERVE_1);
