...
contract ReSwapPair is ReSwapCore, ERC20, ReentrancyGuard, IReSwapFlashLender {
    ...
    function update(uint256 balance0, uint256 balance1, uint112 _reserve0, uint112 _reserve1) internal {
        ...
        unchecked {
            ...
            if (timeElapsed > 0 && _reserve0 != 0 && _reserve1 != 0) {
                uint256 value0 = uint256(UQ112x112.encode(_reserve1).uqdiv(_reserve0));
                uint256 value1 = uint256(UQ112x112.encode(_reserve0).uqdiv(_reserve1));
    ...
    function finalizeTransferPair(address tokenA, address tokenB, uint256 amountOutA, uint256 amountOutB, address to)
        internal
    {
